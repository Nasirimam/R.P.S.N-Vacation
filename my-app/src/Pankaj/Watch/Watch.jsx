        ...
        <Slider {...settings}>
          <div className={styles.box} style={{ color: "black" }}>
            ...
            <div className={styles.des} style={{ color: "black" }}>
              Best Weekend Getaways From Mumbai Under 250 Kms
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by} style={{ color: "black" }}>
                By
              </span>{" "}
              <span style={{ color: "black" }} className={styles.byname}>
                Namita Mittal
              </span>
            </div>
          </div>
          ...
          <div className={styles.box}>
            <div className={styles.imgdiv}>
              <img
                src="https://cdn1.tripoto.com/media/filter/tst/gen/1789711/Image/1634027829_thumbnail.jpg"
                className={styles.imge}
              />
            </div>

            <div className={styles.des}>10 Best Budget Hotels InDia</div>
            <div className={styles.bydiv}>
              <span className={styles.by}>By</span>{" "}
              <span className={styles.byname}>Nimita Mittal</span>
            </div>
          </div>
        </Slider>
      </div>
