        ...
        <Slider {...settings}>
          <div className={styles.box}>
            ...
            <div className={styles.des}>
              Learn Sketchinng & Go On Guided Foreset Walks Around The Himalayan
              Trails | Cosmix Greeks, Dharamkot
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by}>
                <i class="fa-solid fa-location-dot"></i>
              </span>{" "}
              <span className={styles.byname}>Himachal Pradesh</span>
            ...
            <div className={styles.ls}>
              <img
                src="https://cdn1.tripoto.com/media/filter/mss/img/1358539/UserPhoto/1553849222_logo.jpg"
          ...
          <div className={styles.box}>
            <div>
              <img
                src="https://cdn1.tripoto.com/media/filter/tst/img/2176903/Image/1660666126_image_covera.jpg"
                className={styles.imge}
              />
            </div>
            <div className={styles.title}>PACKAGE</div>
            <div className={styles.des}>
              Embrace Minimalistic Community Life & Learn A Traditional Martial
              Art | Beyond Community
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by}>
                <i class="fa-solid fa-location-dot"></i>
              </span>{" "}
              <span className={styles.byname} styles={{ color: "black" }}>
                Sonalika Debnath
              </span>
              <span className={styles.spbtn}>
                <Button className={styles.btn} styles={{ color: "black" }}>
                  3D - 2N
                </Button>
              </span>
              <div className={styles.pri} styles={{ color: "black" }}>
                <div className={styles.prdiv} styles={{ color: "black" }}>
                  <span className={styles.pr} styles={{ color: "black" }}>
                    ₹ 8500{" "}
                    <span styles={{ color: "black" }} className={styles.per}>
                      {" "}
                      / person{" "}
                    </span>
                  </span>
          ...
          <div className={styles.box}>
            <div>
              <img
                src="https://cdn1.tripoto.com/media/filter/tst/img/2163002/Image/1638778652_image_cover_b.jpg"
                className={styles.imge}
              />
            </div>
            <div className={styles.title}>PACKAGE</div>
            <div className={styles.des}>
              Leaarn To Cook A Traditional Rajasthani Meal At A 200 Year-old
              Luxury Haveli
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by}>
              ...
              <span className={styles.byname}>Rajasthan</span>
              <span className={styles.spbtn}>
                <Button className={styles.btn} style={{ marginLeft: "5rem" }}>
                  3D - 2N
                </Button>
              </span>
              <div className={styles.pri}>
            ...
            <div className={styles.ls}>
              <img
                ...
                className={styles.lsimg}
              />
              <span className={styles.lstex}>Tripoto Verified Partner</span>
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>PACKAGE</div>
            <div className={styles.des}>
              Trek To Triund And Stay At The Residence Of Kangra's Maharaja |
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>PACKAGE</div>
            <div className={styles.des}>
              Stargaze & Enjoy A Picnic In the Hills As You Stay At A Unique
              A-Framed Cottage | Urna Boutique Stay
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by}>
                <i class="fa-solid fa-location-dot"></i>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.title}>PACKAGE</div>
            <div className={styles.des}>
              Explore One Of Asia's Spookiest Spots While Unwinding Amidst
              Nature
            </div>
            <div className={styles.bydiv}>
              <span className={styles.by}>
