        ...
        <Slider {...settings}>
          <div className={styles.box}>
            ...
            <div className={styles.ls}>
              ...
              <span>
                <div styles={{ color: "black" }} className={styles.check}>
                  <i style={{ color: "#fff" }} class="fa-solid fa-check"></i>
                </div>
              </span>
            </div>
          </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.des} styles={{ color: "black" }}>
              ...
              Nature | Seegreen Lodges, Mussoorie
            </div>
            <div className={styles.bydiv} styles={{ color: "black" }}>
              ...
              <span className={styles.spbtn} styles={{ color: "black" }}>
                <Button
                  className={styles.btn}
                  style={{ marginRight: "3.6rem", color: "black" }}
                >
                  3D - 2N
                </Button>
              </span>
            ...
            <div className={styles.ls} styles={{ color: "black" }}>
              ...
              <span>
                <div className={styles.check} styles={{ color: "black" }}>
                  <i style={{ color: "#fff" }} class="fa-solid fa-check"></i>
                </div>
              </span>
            </div>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.des} styles={{ color: "black" }}>
              ...
              Art | Beyond Commuunity, Auroville
            </div>
            <div className={styles.bydiv} styles={{ color: "black" }}>
              <span className={styles.by} styles={{ color: "black" }}>
                <i class="fa-solid fa-location-dot"></i>
          ...
          <div className={styles.box}>
            ...
            <div className={styles.des} styles={{ color: "black" }}>
              Learn Sketching & Go On Guided Forest WAlk Around The Himalayan
              Trails | Cosmic Greek, Dharamkot
            </div>
            <div className={styles.bydiv} styles={{ color: "black" }}>
              <span className={styles.by} styles={{ color: "black" }}>
                <i class="fa-solid fa-location-dot"></i>
              ...
              <span className={styles.spbtn} styles={{ color: "black" }}>
                <Button
                  className={styles.btn}
                  style={{ marginLeft: "-4rem", color: "black" }}
                >
                  3D - 2N
                </Button>
              </span>
            ...
            <div className={styles.ls}>
              <img
                ...
                className={styles.lsimg}
              />
              <span className={styles.lstex}>Tripoto Mindful retreats</span>
              <span>
                <div className={styles.check}>
                  <i style={{ color: "#fff" }} class="fa-solid fa-check"></i>
                </div>
